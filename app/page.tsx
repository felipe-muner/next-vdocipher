  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Three Column Layout: Upload, Your Videos, Test */}
                ...
                <div className="space-y-2 max-h-96 overflow-y-auto">
                  {videos.map((video) => (
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-lg border-2 transition-all hover:border-blue-500 hover:bg-blue-50 ${
                    ...
                    >
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-0.5 mt-1 text-xs text-gray-500">
                          <span>
                            {new Date(video.upload_time * 1000).toLocaleDateString()} {new Date(video.upload_time * 1000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                          </span>
